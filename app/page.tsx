...
import { CheckCircle, ShieldAlert, ArrowRight, LogOut, Building, Server, Shield, Clock, XCircle, AlertTriangle, RefreshCw, Check as CheckIcon, Lock, Database, FileWarning } from "lucide-react"
        ...
        <main className="flex-1">
            ...
            <div className="container px-4 md:px-6">
              ...
              <div className="max-w-4xl mx-auto mb-20">
                <div className="bg-card rounded-lg shadow-xl overflow-hidden border border-border">
                  ...
                  <div className="h-8 bg-muted border-b border-border flex items-center px-4">
                    ...
                    <div className="absolute left-0 right-0 mx-auto text-center text-xs text-muted-foreground font-medium" style={{ width: 'fit-content' }}>Supabase Compliance Dashboard</div>
                  </div>
              ...
              <div className="max-w-5xl mx-auto">
                <div className="flex items-center gap-3 mb-8 relative">
                  ...
                  <p className="text-muted-foreground">Compliance checks are automatically run and verified in real-time.</p>
                </div>
                  ...
                  <div className="bg-card rounded-lg border border-border shadow-sm overflow-hidden transition-all duration-300 hover:shadow-md">
                    <div className="p-4 border-b border-border flex justify-between items-center">
                      <div className="flex items-center">
                        ...
                        <span className="font-medium text-foreground">Auth Configuration</span>
                      </div>
                    ...
                    <div className="divide-y divide-gray-100">
                      <div className="flex justify-between items-center p-4 animate-pulse bg-gradient-to-r from-background to-blue-500/5 dark:from-background dark:to-blue-400/10">
                        <div className="flex items-center">
                          <div className="w-8 h-8 rounded-full bg-muted mr-3 flex items-center justify-center text-xs text-muted-foreground">U1</div>
                          <div>
                      ...
                      <div className="flex justify-between items-center p-4">
                        <div className="flex items-center">
                          <div className="w-8 h-8 rounded-full bg-muted mr-3 flex items-center justify-center text-xs text-muted-foreground">U2</div>
                          <div>
                      ...
                      <div className="flex justify-between items-center p-4 bg-blue-50 dark:bg-blue-950/20">
                        <div className="flex items-center">
                          <div className="w-8 h-8 rounded-full bg-muted mr-3 flex items-center justify-center text-xs text-muted-foreground">U3</div>
                          <div>
                  ...
                  <div className="bg-card rounded-lg border border-border shadow-sm overflow-hidden transition-all duration-300 hover:shadow-md">
                    <div className="p-4 border-b border-border flex justify-between items-center">
                      <div className="flex items-center">
                        ...
                        <span className="font-medium text-foreground">Database Security</span>
                      </div>
                    ...
                    <div className="divide-y divide-gray-100">
                      <div className="flex justify-between items-center p-4">
                        <div>
                          ...
                          <div className="text-xs text-muted-foreground">public schema</div>
                        </div>
                        <div className="text-green-600 flex items-center">
                          <CheckCircle className="h-4 w-4 mr-1" />
                      ...
                      <div className="flex justify-between items-center p-4 animate-pulse bg-gradient-to-r from-background to-amber-500/5 dark:from-background dark:to-amber-400/10">
                        <div>
                  ...
                  <div className="bg-card rounded-lg border border-border shadow-sm overflow-hidden transition-all duration-300 hover:shadow-md">
                    <div className="p-4 border-b border-border flex justify-between items-center">
                      <div className="flex items-center">
                        ...
                        <span className="font-medium text-foreground">Backup Configuration</span>
                      </div>
                      <div className="bg-green-100 text-green-800 text-xs px-2 py-1 rounded-full flex items-center">
                        <CheckCircle className="h-3 w-3 mr-1" />
                        <span>Compliant</span>
          ...
          <section className="w-full py-12 md:py-24 lg:py-32 bg-muted dark:bg-black/60">
            <div className="container px-4 md:px-6">
              ...
              <StaggerContainer className="mx-auto grid justify-center gap-6 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 lg:gap-8 xl:gap-10 mt-12">
                <StaggerItem>
                  <Card className="h-full transition-all duration-200 hover:shadow-lg border-border">
                    ...
                    <CardContent>
                      <p className="text-muted-foreground">
                        ...
                        Supabase can take care of for you, and some things that you are responsible for.
                      </p>
                    </CardContent>
                  </Card>
                </StaggerItem>
                  ...
                  <Card className="h-full transition-all duration-200 hover:shadow-lg border-border">
                    ...
                    <CardContent>
                      <p className="text-muted-foreground">
                        ...
                        sensitive data and make sure users only access what they're allowed to see.
                      </p>
                    </CardContent>
                  </Card>
                </StaggerItem>
                  ...
                  <Card className="h-full transition-all duration-200 hover:shadow-lg border-border">
                    ...
                    <CardContent>
                      <p className="text-muted-foreground">
                        ...
                        load, and remains available whilst in production.
                      </p>
                    </CardContent>
                  </Card>
                </StaggerItem>
